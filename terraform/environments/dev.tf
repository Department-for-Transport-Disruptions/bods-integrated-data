...
module "database_analyst_access" {
  source = "git::https://github.com/department-for-transport-BODS/BODDS-INFRASTRUCTURE.git//terraform/modules/database_analyst_access?ref=feature/test-credentials-parameter-store"
