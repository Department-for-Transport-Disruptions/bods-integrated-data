...
export const tflVehicleLocationSchema = z.object({
    ...
    headwayDeviation: z.number().optional(),
    scheduleDeviation: z.number().optional(),
    vehicleState: z.number().optional(),
    nextStopPointId: z.string().optional(),
    nextStopPointName: z.string().optional(),
    previousStopPointId: z.string().optional(),
    previousStopPointName: z.string().optional(),
    lineRef: z.string().optional(),
    publishedLineName: z.string().optional(),
    directionRef: z.number(),
    originName: z.string().optional(),
    originRef: z.string().optional(),
    originAimedDepartureTime: z.number().optional(),
