...
const vehicleActivitySchema = z.object({
    ...
    MonitoredVehicleJourney: z.object({
        ...
        OnwardCalls: z
            .object({
                OnwardCall: makeFilteredArraySchema("SiriVmVehicleActivitySchema", onwardCallSchema),
            })
            .or(txcEmptyProperty)
            .optional(),
    }),
...
export const siriSchema = z.object({
    ServiceDelivery: z.object({
        ...
        VehicleMonitoringDelivery: z.object({
            ...
            VehicleActivity: makeFilteredArraySchema("SiriVmSchema", vehicleActivitySchema),
        }),
    }),
});
