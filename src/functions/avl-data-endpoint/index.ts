...
export const handler = async (event: APIGatewayEvent): Promise<APIGatewayProxyResultV2> => {
    try {
        ...
        // parseString(event.body, function (err: unknown, results: unknown) {
        //     // parsing to json
        //     const data = JSON.stringify(results);
        //     eventJson = JSON.parse(data);
        // });
        // console.log(eventJson);
        // const heartbeatSubscribeId = eventJson.HeartbeatNotification.ProducerRef[0];
        // const HeartbeatTime = eventJson.HeartbeatNotification.RequestTimestamp[0];
        // if (eventJson.hasOwnProperty("HeartbeatNotification")) {
        //     logger.info("Heartbeat mil gya");
        //     eventHeartbeatFlag = true as boolean;
        // }
