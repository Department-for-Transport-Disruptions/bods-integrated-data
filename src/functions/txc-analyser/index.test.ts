...
describe("txc-analyser", () => {
    ...
    it.each([
        [
            {
                TXC_OBSERVATION_TABLE_NAME: "",
                NAPTAN_BUCKET_NAME: "test-naptan-bucket",
                NPTG_BUCKET_NAME: "test-nptg-bucket",
            },
        ],
        [{ TXC_OBSERVATION_TABLE_NAME: "test-table", NAPTAN_BUCKET_NAME: "", NPTG_BUCKET_NAME: "test-nptg-bucket" }],
        [{ TXC_OBSERVATION_TABLE_NAME: "test-table", NAPTAN_BUCKET_NAME: "test-naptan-bucket", NPTG_BUCKET_NAME: "" }],
