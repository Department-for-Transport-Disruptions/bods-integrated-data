import * as subscribe from "@bods-integrated-data/shared/cancellations/subscribe";
...
describe("cancellations-subscriber", () => {
    vi.mock("@bods-integrated-data/shared/dynamo", () => ({
        getDynamoItem: vi.fn(),
    }));

    vi.mock("@bods-integrated-data/shared/cancellations/subscribe", () => ({
    ...
    const mockAvlSubscribeMessage: CancellationsSubscribeMessage = {
    ...
    const mockAvlSubscriptionDetails: Omit<CancellationsSubscription, "PK" | "status"> = {
        ...
        lastCancellationsDataReceivedDateTime: null,
    ...
    it("handles resubscribing to a subscription in an error state", async () => {
        getDynamoItemSpy.mockResolvedValue({
            ...
            apiKey: "123",
            heartbeatLastReceivedDateTime: null,
            lastCancellationsDataReceivedDateTime: "2024-09-02T13:34:00Z",
    ...
    it.each([
        [
            {
                TABLE_NAME: "",
                DATA_ENDPOINT: "https://www.test.com/data",
                CANCELLATIONS_PRODUCER_API_KEY_ARN: "mock-key-arn",
            },
        ],
        [{ TABLE_NAME: "test-dynamo-table", DATA_ENDPOINT: "", CANCELLATIONS_PRODUCER_API_KEY_ARN: "mock-key-arn" }],
        [
            {
                TABLE_NAME: "test-dynamo-table",
                DATA_ENDPOINT: "https://www.test.com/data",
                CANCELLATIONS_PRODUCER_API_KEY_ARN: "",
            },
        ],
